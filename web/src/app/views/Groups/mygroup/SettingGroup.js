...
export default function SettingGroup(props) {
    ...
    var show = addAdmin ?
    <input type="text" className="form-control add-admin" name="member" placeholder="Chọn thành viên"></input>
    : <div></div>;
        ...
        <div className="card col-lg-4 col-sm-12 col-md-12">
            <div className="card-body">
                <div className="flex-setting">
                    <button type="button" name="" className="btn btn-block btn-admin"
