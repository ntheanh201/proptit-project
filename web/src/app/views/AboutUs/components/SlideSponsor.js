...
export default function SlideSponsor() {
    ...
    var showPeopleGold =
            <div className="list-people">
                <div className="show-people">
                    <div className="ava-spon" style={{backgroundImage: "url(" + goldRank[indexGold.index1].image + ")"}}>
                    </div>
                    <p className="name-spon">{goldRank[indexGold.index1].name}</p>
                    <p className="khoa-spon">{goldRank[indexGold.index1].khoa}</p>
                </div>
                <div className="show-people">
                    <div className="ava-spon" style={{backgroundImage: "url(" + goldRank[indexGold.index2].image + ")"}}>
                    </div>
                    <p className="name-spon">{goldRank[indexGold.index2].name}</p>
                    <p className="khoa-spon">{goldRank[indexGold.index2].khoa}</p>
                </div>
                <div className="show-people">
                    <div className="ava-spon" style={{backgroundImage: "url(" + goldRank[indexGold.index3].image + ")"}}>
                    </div>
    ...
    var showPeopleDiamond = 
            <div className="list-people">
                <div className="show-people">
                    <div className="ava-spon" style={{backgroundImage: "url(" + diamondRank[indexDiamond.index1].image + ")"}}>
                    </div>
                    <p className="name-spon">{diamondRank[indexDiamond.index1].name}</p>
                    <p className="khoa-spon">{diamondRank[indexDiamond.index1].khoa}</p>
                </div>
                <div className="show-people">
                    <div className="ava-spon" style={{backgroundImage: "url(" + diamondRank[indexDiamond.index2].image + ")"}}>
                    </div>
                    <p className="name-spon">{diamondRank[indexDiamond.index2].name}</p>
                    <p className="khoa-spon">{diamondRank[indexDiamond.index2].khoa}</p>
                </div>
                <div className="show-people">
                    <div className="ava-spon" style={{backgroundImage: "url(" + diamondRank[indexDiamond.index3].image + ")"}}>
                    </div>
    ...
    var showPeopleSilver =
            <div className="list-people">
                <div className="show-people">
                    <div className="ava-spon" style={{backgroundImage: "url(" + silverRank[indexSilver.index1].image + ")"}}>
                    </div>
                    <p className="name-spon">{silverRank[indexSilver.index1].name}</p>
                    <p className="khoa-spon">{silverRank[indexSilver.index1].khoa}</p>
                </div>
                <div className="show-people">
                    <div className="ava-spon" style={{backgroundImage: "url(" + silverRank[indexSilver.index2].image + ")"}}>
                    </div>
                    <p className="name-spon">{silverRank[indexSilver.index2].name}</p>
                    <p className="khoa-spon">{silverRank[indexSilver.index2].khoa}</p>
                </div>
                <div className="show-people">
                    <div className="ava-spon" style={{backgroundImage: "url(" + silverRank[indexSilver.index3].image + ")"}}>
                    </div>
        ...
        <div className="sponsors">
            <div className="diamond">
                ...
                <div className="show-sponsor">
                    <i className="fa fa-angle-left control-sponsor control-diamond"
                        onClick={toLeftDiamond}
                    ></i>
                    {showPeopleDiamond}
                    <i className="fa fa-angle-right control-sponsor control-diamond"
            ...
            <div className="gold">
                ...
                <div className="show-sponsor">
                    <i className="fa fa-angle-left control-sponsor control-gold"
                        onClick={toLeftGold}
                    ></i>
                    {showPeopleGold}
                    <i className="fa fa-angle-right control-sponsor control-gold"
                        onClick={toRightGold}
                    ></i>
                </div>
            </div>
            <div className="silver">
                ...
                <div className="show-sponsor">
                    <i className="fa fa-angle-left control-sponsor control-silver"
                        onClick={toLeftSilver}
                    ></i>
                    {showPeopleSilver}
                    <i className="fa fa-angle-right control-sponsor control-silver"
